...
export default function ContactPage() {
  ...
  if (!formData.service || !formData.budget) {
    alert("Please select both a design service type and a budget range.");
    return;
  }
      ...
      <div className="container mx-auto px-4 py-12">
        <section className="text-center mb-16">
          ...
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
            ...
            or print design — I'm here to bring your vision to life.
          </p>
        </section>
            ...
            <Card>
              ...
              <CardContent>
                <form onSubmit={handleSubmitEmail} className="space-y-6">
                  ...
                  <div className="grid md:grid-cols-2 gap-4">
                    <div className="space-y-2">
                      <Label htmlFor="service">Type of Design Service</Label>
                      <Select
                      ...
                      >
                        ...
                        <SelectContent>
                          <SelectItem value="logo-brand-identity">
                            Logo & Brand Identity
                          </SelectItem>
                          <SelectItem value="social-media-graphics">
                            Social Media Graphics
                          </SelectItem>
                          <SelectItem value="print-design">
                            Print & Marketing Design
                          </SelectItem>
                          <SelectItem value="packaging-design">
                            Packaging & Product Design
                          </SelectItem>
                          <SelectItem value="full-brand-package">
                            Full Brand Package
                          </SelectItem>
                  ...
                  <div className="space-y-2">
                    ...
                    <Textarea
                      id="message"
                      placeholder="Tell me about your design project, brand style, target audience, and any references you love..."
                      rows={6}
              ...
              <CardContent className="space-y-4">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground">+92 344-4091634</p>
                  </div>
                </div>
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground">Multan, Punjab Pakistan. </p>
                  </div>
                </div>
              </CardContent>
            </Card>
            ...
            <Card>
              ...
              <CardContent>
                <div className="flex gap-4">
                  ...
                  <Button size="icon" variant="outline" asChild>
  <a
    href="mailto:baatooltahira786@gmail.com  ?subject=Contact%20Ramsha%20Khan&body=Hello%20Ramsha,"
  ...
  >
    <Mail className="h-4 w-4" />
            ...
            <Card>
              ...
              <CardContent>
                <p className="text-muted-foreground">
                  I typically respond within 24 hours. If your design request
